...
<aside class="sidebar shadow" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        @if($role === 'staff')
            <x-admin.nav-item route="staff.orders.create" icon="bi-plus-circle text-info" label="New Order" />
        @endif
        <x-admin.nav-item route="{{ $role }}.orders.index" icon="bi-basket" label="Laundries" />
