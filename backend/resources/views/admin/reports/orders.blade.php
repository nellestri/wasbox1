...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-0 fw-bold">Orders Report</h2>
            <p class="text-muted mb-0">Detailed order history</p>
        </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mb-0 text-success">{{ number_format($summary['completed_orders']) }}</h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mb-0 text-warning">{{ number_format($summary['pending_orders']) }}</h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="card-body">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mt-3">No orders found for this period</p>
                </div>
            @endif
        </div>
    </div>
