            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @if($pickup->status == 'picked_up' && !$pickup->order_id)
                        <hr>
                        <a href="{{ route('admin.orders.create', ['pickup_id' => $pickup->id]) }}" class="btn btn-outline-primary w-100">
            ...
            @if($pickup->order_id)
                <div class="card mb-4">
                    <div class="card-header bg-warning">
                        <h6 class="mb-0">Linked Order</h6>
                    </div>
                    <div class="card-body">
                        <p><strong>Order #{{ $pickup->order_id }}</strong></p>
                        <a href="{{ route('admin.orders.show', $pickup->order_id) }}" class="btn btn-sm btn-outline-primary">
