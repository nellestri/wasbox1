                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-4">
                            <div class="text-center p-2 bg-light rounded">
                                <div class="fw-bold text-dark">{{ number_format($branch->orders_mtd ?? 0) }}</div>
                                <small class="text-muted">MTD Orders</small>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="text-center p-2 bg-light rounded">
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="text-center">
                                <div class="fw-bold fs-4 text-dark">{{ number_format($total_orders) }}</div>
