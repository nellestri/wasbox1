...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <p class="text-muted small mb-0">Manage walk-in and mobile app registered customers across all branches.</p>
        </div>
        <a href="{{ route('admin.customers.create') }}" class="btn btn-primary shadow-sm px-4" style="background: #3D3B6B; border: none;">
        ...
        <form method="GET" class="row g-3 align-items-center">
            ...
            <div class="col-md-3">
                <select name="branch_id" class="form-select border-0 bg-light" onchange="this.form.submit()">
                    <option value="">All Branches (Sibulan/Duma/Bais)</option>
            ...
            <div class="col-md-5">
                <div class="input-group">
                    ...
                    @if(request()->anyFilled(['search', 'branch_id', 'status', 'registration_type']))
                        <a href="{{ route('admin.customers.index') }}" class="btn btn-outline-danger border-0 bg-light"><i class="bi bi-x-circle"></i></a>
                    @endif
                </div>
            </div>
        </form>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($customer->preferredBranch)
                                <span class="badge border text-dark fw-normal px-2"><i class="bi bi-geo-alt me-1"></i> {{ $customer->preferredBranch->name }}</span>
                            @else
                        ...
                        <td class="text-end pe-4">
                            <div class="btn-group">
                                <a href="{{ route('admin.customers.show', $customer) }}" class="btn btn-sm btn-outline-secondary border-0" title="View Details">
                                    <i class="bi bi-eye-fill"></i>
                                </a>
                                <a href="{{ route('admin.customers.edit', $customer) }}" class="btn btn-sm btn-outline-secondary border-0" title="Edit Customer">
                    ...
                    <tr>
                        <td colspan="8" class="text-center py-5">
                            ...
                            <a href="{{ route('admin.customers.index') }}" class="btn btn-sm btn-link text-decoration-none">Clear all filters</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
