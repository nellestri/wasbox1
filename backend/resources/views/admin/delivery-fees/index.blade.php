                        ...
                        <tbody>
                            @foreach($branches as $branch)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($fee && $fee->minimum_order_for_free)
                                            <span class="badge bg-warning text-dark">
                                                ₱{{ number_format($fee->minimum_order_for_free, 2) }}
                                            </span>
                                        @else
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number"
                                                                       name="minimum_order_for_free"
                                                                       class="form-control"
                                                                       value="{{ $fee->minimum_order_for_free ?? '' }}"
                                                                       step="0.01"
                                                                       min="0"
                                                                       placeholder="Leave empty for no minimum">
                                                                <small class="text-muted">Free delivery when order total reaches this amount</small>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-warning mt-3">
                ...
                <strong>Free Delivery Feature:</strong> When a customer's order reaches the minimum amount you set,
