            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white border-bottom py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.orders.index', ['staff_id' => $staff->id]) }}" class="btn btn-sm btn-outline-secondary">
                            View All
                        </a>
                    </div>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="p-3 border-bottom {{ $loop->last ? 'border-0' : '' }}">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <strong class="d-block mb-1">#{{ $order->order_number ?? $order->id }}</strong>
                            ...
                            <div class="text-end">
                                ...
                                <strong class="d-block" style="color: #3D3B6B;">₱{{ number_format($order->total_amount, 2) }}</strong>
                            </div>
                        </div>
                    </div>
                    @empty
