...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    <li class="breadcrumb-item"><a href="{{ route('staff.customers.index') }}" class="text-decoration-none">Customers</a></li>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('staff.customers.edit', $customer->id) }}" class="btn btn-primary shadow-sm" style="background: #3D3B6B; border-color: #3D3B6B;">
