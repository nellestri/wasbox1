...
class DeliveryFeesController extends Controller
{
    ...
    public function update(Request $request, $branchId)
    {
        $request->validate([
            ...
            'minimum_order_for_free' => 'nullable|numeric|min:0',
        ...
        DeliveryFee::updateOrCreate(
            ...
            [
                ...
                'minimum_order_for_free' => $request->minimum_order_for_free,
    ...
    public function show($branchId)
    {
        ...
        return response()->json([
            ...
            'minimum_order_for_free' => $deliveryFee->minimum_order_for_free,
        ]);
    }
    ...
    public function calculatePreview(Request $request)
    {
        ...
        $fees = $deliveryFee->calculateFee($request->service_type, $request->order_amount);
