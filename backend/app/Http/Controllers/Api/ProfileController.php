...
class ProfileController extends Controller
{
     ...
     * Body: { "subject": "Issue with order", "message": "..." }
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\JsonResponse
     */
    ...
    public function faqs()
    {
        $faqs = [
            [
                ...
                'answer' => 'Simply select your preferred branch, choose a service, enter the weight of your laundry, and submit your order.',
            ],
            [
            ...
            [
                ...
                'answer' => 'Yes, you can cancel your order before it has been received by the branch staff.',
            ],
            [
                'question' => 'Do you offer pickup and delivery?',
                'answer' => 'Yes, we offer pickup and delivery services. You can request a pickup when placing your order.',
            ],
        ];
