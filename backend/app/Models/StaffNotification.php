...
class StaffNotification extends Model
{
    ...
    /**
     * Notify staff of new order assigned
     */
    public static function notifyOrderAssigned($order, $staffId)
    {
        return self::create([
            'user_id' => $staffId,
            'type' => 'order_assigned',
    ...
    /**
     * Notify staff of urgent unclaimed order
     */
    public static function notifyUrgentUnclaimed($order, $staffId)
    {
        return self::create([
            'user_id' => $staffId,
            'type' => 'urgent_pickup',
            'title' => 'Urgent: Unclaimed Order',
            'message' => "Order #{$order->tracking_number} unclaimed for {$order->days_unclaimed} days",
