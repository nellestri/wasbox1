...
class Pricing extends Model
{
    ...
    {
        $basePrice = $weight * $this->price_per_kg;
    ...
    public function getDiscountAmountAttribute()
    {
        ...
        return $this->price_per_kg * ($this->discount_percentage / 100);
    }
    ...
    {
        return $this->price_per_kg - $this->discount_amount;
    }
    ...
    public static function getApplicable($serviceId = null, $branchId = null, $weight = null, $date = null)
    {
        ...
        return $query->orderBy('price_per_kg', 'asc')->get();
    }
